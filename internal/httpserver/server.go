...
func NewRouter(application *app.App) http.Handler {
    ...
    r.Use(TracingMiddleware) // Add tracing
    r.Use(MetricsMiddleware(application.Metrics)) // Add metrics
    ...
    r.Route("/api/v1", func(r chi.Router) {
        ...
        r.Post("/echo", handlers.NewEchoHandler(application.ExampleService))
    })
